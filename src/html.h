...
<head>
  ...
  <style>
    ...
    .title1 { font-size: 1.2rem; font-weight: bold; color: --text-color; }
    .alnright { text-align: right; }
    .topnav { overflow: hidden; background-color:var(--topnav-color); color: white; font-size:1.5rem; margin:0px; padding:0px }
    .content { padding: 10px; }
    .card { background-color: var(--base-variant) ; padding: 5px; box-shadow: 2px 2px 12px 1px var(--card-shadow); }
